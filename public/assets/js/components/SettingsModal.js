...
export default {
  ...
  template: `
    <modal :title="t('Settings')" width="560px" @close="closeModal">
      ...
      <label class="switch" style="margin-bottom:14px"><input type="checkbox" :checked="store.prefs.show_weekends" @change="set({ show_weekends: $event.target.checked })"><span class="track"></span>{{ t('Show weekends') }}</label>
